...
DROP POLICY IF EXISTS "Finance and admins can view bank_accounts_config" ON bank_accounts_config;
...
DROP POLICY IF EXISTS "Leaders and finance can view contract_pricing" ON contract_pricing;
