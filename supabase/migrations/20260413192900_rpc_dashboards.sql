...
-- Generates strict cash flow tracking (paid expenses/invoices) 
-- ============================================================
CREATE OR REPLACE FUNCTION public.get_cashflow_summary(p_start_date date, p_end_date date, p_branch_ids uuid[] DEFAULT NULL)
RETURNS jsonb
...
-- ============================================================
-- RPC: get_cost_center_summary
-- Aggregates income and expenses by cost center using DB efficiency
-- ============================================================
CREATE OR REPLACE FUNCTION public.get_cost_center_summary(p_start_date date, p_end_date date, p_branch_id uuid DEFAULT NULL)
RETURNS jsonb
LANGUAGE sql STABLE SECURITY DEFINER SET search_path TO 'public'
AS $$
